...
void BatteryInfoModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->maxCapacityChanged((*reinterpret_cast< std::add_pointer_t<double>>(_a[1]))); break;
        ...
        case 5: _t->currentCapacityChanged((*reinterpret_cast< std::add_pointer_t<double>>(_a[1]))); break;
        ...
        {
            using _t = void (BatteryInfoModel::*)(double );
            if (_t _q_method = &BatteryInfoModel::maxCapacityChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        ...
        {
            using _t = void (BatteryInfoModel::*)(double );
            if (_t _q_method = &BatteryInfoModel::currentCapacityChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 5;
                return;
            }
        }
...
// SIGNAL 2
void BatteryInfoModel::maxCapacityChanged(double _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 5
void BatteryInfoModel::currentCapacityChanged(double _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
